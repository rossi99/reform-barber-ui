...
const canNext = computed(
  () =>
    !(
      viewMonth.value.getMonth() === maxMonth.getMonth() &&
      viewMonth.value.getFullYear() === maxMonth.getFullYear()
    ),
);
      ...
      <template v-else>
        ...
        <div class="slots__body">
          <template v-if="availability?.groups">
            ...
            <div
              v-if="availability.groups.afternoon.length"
              class="slots__group"
            >
              <div class="g-label">
            ...
            <div
              v-if="
                !availability.groups.morning.length &&
                !availability.groups.afternoon.length &&
                !availability.groups.evening.length
              "
              class="slots__empty"
            >
              Closed this day.
...
.slots__body::-webkit-scrollbar {
  width: 6px;
}
.slots__body::-webkit-scrollbar-track {
  background: transparent;
}
.slots__body::-webkit-scrollbar-thumb {
  background: var(--rule);
}
.slots__body::-webkit-scrollbar-thumb:hover {
