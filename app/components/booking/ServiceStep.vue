...
<template>
  <div class="step__head">
    ...
    <div class="step-meta">
      For <span class="v">{{ barberName || "-" }}</span>
    </div>
  </div>
...
.service-row.is-selected .service-row__name {
  color: var(--brass);
}
...
.service-row.is-selected .service-row__check::after {
  content: "✓";
  font-size: 10px;
  font-weight: 700;
}
.service-row.is-selected .service-row__check {
