...
const frames = [
  ...
  },
  {
    ...
    tag: "precision",
    mono: "F",
    label: "Precision : Bald Fade",
    name: "Skin to Scissor",
    num: "006",
  },
  // divider
  {
  ...
  <section class="gallery">
    <template v-for="(fr, i) in frames" :key="fr.num">
      ...
      <div v-if="i === 2 && active === 'all'" class="div-line">
        <span class="label"
          >Section <span class="colon">:</span> 01 / Cuts</span
        >
      ...
      <div v-if="i === 6 && active === 'all'" class="div-line">
        <span class="label"
          >Section <span class="colon">:</span> 02 / Detail</span
        >
        <span class="rule-line" />
      ...
      >
        <div class="frame__tag">
          <span class="dot" />
          {{ labelParts(fr.label).left }} <span class="colon">:</span>
          {{ labelParts(fr.label).right }}
        </div>
